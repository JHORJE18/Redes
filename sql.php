<?php
$tCONEXION = 'CREATE TABLE IF NOT EXISTS `conexion` (
...
$tREDES = 'CREATE TABLE IF NOT EXISTS `redes` (
...
$tUSUARIO = 'CREATE TABLE IF NOT EXISTS `usuario` (
...
$relaciones = 'ALTER TABLE `conexion`
