...
<div class="mdl-cell mdl-cell--4-col">
    ...
    <a href="asistente.php?accion=delTODO"><div class="mdl-button mdl-js-button mdl-button--accent mdl-js-ripple-effect"><i class="material-icons">delete_forever</i>Eliminar TODO</div></a>
    <a href="asistente.php?accion=delBBDD"><div class="mdl-button mdl-js-button mdl-button--accent mdl-js-ripple-effect"><i class="material-icons">delete</i>Eliminar Base de datos</div></a>
