              ...
              if ($numCNX != null){
                for ($i=0; $i<$numCNX; $i++){
                  ...
                  if ($resultado = $conexion -> query($red)){
                    ...
                    echo '<a href="'.$valores[0].'" target="_blank"><div class="mdl-button mdl-js-button mdl-button--accent mdl-js-ripple-effect"><i class="material-icons">arrow_forward</i> '.$valores[1].'</div></a>';
                  }
                }
              } else {
